...
def graph_01(df_renta: pd.DataFrame) -> MaterializeResult:
    ...
    path = "Practica_03/visualizaciones/graph_01_distribucion_renta.png"
...
def graph_02(df_renta_isla: pd.DataFrame) -> MaterializeResult:
    ...
    path = "Practica_03/visualizaciones/graph_02_linea_gomera_sueldos_salarios.png"
...
def graph_03(df_renta_isla: pd.DataFrame) -> MaterializeResult:
    ...
    path = "Practica_03/visualizaciones/graph_03_heatmap_palma_desempleo.png"
    plot.save(path, width=12, height=7, dpi=300)
...
def graph_04(df_renta_edu: pd.DataFrame) -> MaterializeResult:
    ...
    path = "Practica_03/visualizaciones/graph_04_scatter_palma_salario_educación_2023.png"
